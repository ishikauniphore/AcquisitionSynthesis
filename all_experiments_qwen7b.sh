...
# source run_eval.sh "ishikauniphore/student_SelectedGT_qwen7bins_${DATASET}"
...
# source run_eval.sh "ishikauniphore/student_qwen7bins_${DATASET}_answerdiff"
...
# source run_eval.sh "ishikauniphore/student_qwen7bins_${DATASET}_hlrep"
